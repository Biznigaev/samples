...
?>
<h1 class="H1">Терминал: <?=str_replace('Терминал', '', $arResult['NAME'])?></h1>
<p></p>
...
?>
		...
		<p>
			<div>
				<img src="/images/icons/clock.png" alt="Режим работы" />&nbsp;&nbsp;<span style="position: absolute; margin: 2px 0 0 0 "><b>Режим работы: </b><?=$arResult['WORK_MODE']?></span>
			</div>
		</p>
		<p></p>

		<strong>Услуги терминала</strong>
		<br />
		<br />
		...
		<ul>
			...
			<li>— МГТС и Ростелеком</li>
			<li>— коммерческое ТВ и Интернет</li>
			<li>— коммунальные платежи</li>
			<li>— штрафы ГИБДД</li>
		</ul>
		<br />
<? if (count($arResult['SERVICES']['FIZ'])): ?>
		<strong>Пополнение электронных кошельков.</strong>
		<br /><br /><br />
<? endif ?>
<? if ($arResult['CARD_IN_TERM'] === true): ?>
		<strong>
			<img align="top" class="small_icon" src="/images/icons/small_card.gif" alt="Терминал принимает наличные и карты" />&nbsp;Терминал принимает наличные и карты.
		</strong>
		<br />
		<font>Возможно погашение кредитов МКБ и других банков, пополнение карты, счёта и вклада в банке.</font>
		<br />
<? endif ?>
<? if ($arResult['COMISSION'] === true): ?>
		<br />
		<strong>
			<img align="top" class="small_icon" src="/images/icons/zero_fee.png" alt="Оплата мобильной связи без комиссии" />&nbsp;<font>Оплата мобильной связи без комиссии</font>
		</strong>
		<br />
<? endif ?>
